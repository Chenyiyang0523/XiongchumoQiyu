...
define gui.accent_color = '#F6B73C'

## 当文本按钮既未被选中也未被悬停时使用的颜色。
define gui.idle_color = '#E8DDBB'

## 小的颜色用于小的文本，需要更亮/更暗才能达到同样的效果。
define gui.idle_small_color = '#D6C9A3'

## 当按钮和滑条被悬停时使用的颜色。
define gui.hover_color = '#FFD166'
...
## 当文本按钮无法被选择时使用的颜色。
define gui.insensitive_color = '#8B927F88'

## 滑条未填充的部分使用的颜色。这些颜色不直接使用，但在重新生成条形图像文件时使
## 用。
define gui.muted_color = '#2F6B3F'
define gui.hover_muted_color = '#4D8A5D'

## 对话和菜单选择文本使用的颜色。
define gui.text_color = '#FFF4D6'
define gui.interface_text_color = '#FFF4D6'
...
## 角色名称使用的字体。
define gui.name_text_font = "ZCOOLKuaiLe-Regular.ttf"
...
define gui.namebox_borders = Borders(15, 8, 15, 8)
...
## 0.5 来居中。
define gui.dialogue_xpos = 112
define gui.dialogue_ypos = 196
...
## 对话文本的行间距。
define gui.dialogue_line_spacing = 5
...
define gui.choice_button_text_idle_color = '#FFF4D6'
define gui.choice_button_text_hover_color = "#FFFFFF"
define gui.choice_button_text_insensitive_color = '#6b5a3e7f'
...
## 存档位按钮。
define gui.slot_button_width = 360
define gui.slot_button_height = 360
